...
class JobListOptionsTest extends TestCase
{
    public function testGetQueryParameters(): void
    {
        ...
        $jobListOptions->setDelayedStartTime(DateTime::createFromFormat('Y-m-d H:i:s', '2023-02-20 1:12:23'));
        ...
        self::assertSame('2023-02-20 01:12:23', $jobListOptions->getDelayedStartTime()->format('Y-m-d H:i:s'));
        ...
        $expected = [
            ...
            'delayedStartTime=' . urlencode('2023-02-20T01:12:23+00:00'),
        ];
